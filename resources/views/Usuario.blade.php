                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#EliminarUser" id="eliminarUser"><i class="fas fa-solid fa-trash"></i></button>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
            ...
            <div class="modal-body">
              <form method="POST" action="{{ route('eliminar_user') }}" enctype="multipart/form-data" id="formeliminar">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="{{$user->name}}"required autocomplete="on" disabled>
